...
public class PlanterDTO {
	...
	public PlanterDTO(Integer planterId, float planterheight, int planterCapacity, int drinageHoles, int planterColor,
			String planterShape, int planterStock, int planterCost, Plant plant, Seed seed) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PlanterDTO other = (PlanterDTO) obj;
	...
	public String toString() {
		return "PlanterDTO [planterId=" + planterId + ", planterheight=" + planterheight + ", planterCapacity="
