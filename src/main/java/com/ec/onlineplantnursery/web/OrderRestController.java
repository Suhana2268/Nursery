...
public class OrderRestController {
	...
	@PostMapping("/add")
	public ResponseEntity<OrderResponseDto> insertOrder(@RequestBody @Valid OrderRequestDTO orderdto)
	...
	@GetMapping("/{id}")
	@ApiOperation(value = "Seed Get mapping to fetch order by Id", response = Order.class)
	public ResponseEntity<OrderResponseDto> viewOrderById(@PathVariable int id)
