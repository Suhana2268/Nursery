...
public class PlanterRestController {
	...
	@PutMapping("/update")
	public ResponseEntity<PlanterResponseDto> updatePlanter(@RequestBody PlanterRequestDto planterDto)
			throws ResourceNotFoundException {
	...
	public ResponseEntity<PlanterResponseDto> deletePlanter(@RequestBody PlanterRequestDto planterDto)
			throws ResourceNotFoundException// through id
	{
	...
	public ResponseEntity<PlanterResponseDto> viewPlanter(@PathVariable int planterId)
			throws ResourceNotFoundException {
	...
	public List<PlanterResponseDto> viewAllPlanters(@PathVariable double minCost, @PathVariable double maxCost)
			throws ResourceNotFoundException {
