...
public class PlanterServiceImplTest {
	...
	@Test
	void testViewPlanterByIdException() {
	...
	void testViewPlanterByShape() throws ResourceNotFoundException {
	    ...
	    Seed seed = new Seed("Money", "One week", "Once a day", "easy", "20ºC", "Monocotyledonous", "This seed is a small embryonic plant", 20, 100.0, 1000);
	    seed.setSeedId(2);
	...
	void testDeletePlanterException() {
	...
	@Test
	void testUpdatePlanterException() {
